...
export const Dashboard = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    //if (!playlists) Router.push('/addPlaylist?first=true')
  ...
  return (
    <div className="container">
      ...
      <Sidebar playlists={playlists} removePlaylist={handleRemovePlaylist} />
      <main>
        <h1 className="title">
          Welcome to the <a href="https://open.spotify.com/">Spotify</a>{' '}
          Playlist Playground!
        </h1>
